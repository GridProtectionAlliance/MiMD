...
--IF  NOT EXISTS (SELECT * FROM sys.server_principals WHERE name = N'MiMD')
--CREATE LOGIN [NewUser] WITH PASSWORD=N'MyPassword', DEFAULT_DATABASE=[master], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
--GO

--USE [MiMD]
--GO
--CREATE USER [MiMD] FOR LOGIN [MiMD]
--GO
--CREATE ROLE [MiMDAdmin] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'MiMDAdmin', N'MiMD'
--GO
