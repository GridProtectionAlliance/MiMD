...
export default class CFGParser {
    ...
    constructor(contents: string, meterKey: string) {
        ...
        this.Analogs = data.slice(2, analogCounts + 2).map((a: Array<string>, index) => { return { ID: index, Meter: meterKey, Asset: '', MeasurementType: this.parseType(a[4]), MeasurementCharacteristic: 'Instantaneous', Phase: this.parsePhase(a[2]), Name: a[1], SamplesPerHour: 0, PerUnitValue: null, HarmonicGroup: 0, Description: a[3], Enabled: true, Series: { ID: 0, ChannelID: 0, SeriesType: 'Values', SourceIndexes: a[0] } as OpenXDA.Series } as OpenXDA.Channel });
        this.Digitals = data.slice(2 + analogCounts, 2 + analogCounts + digitalCounts).map((a: Array<string>, index) => { return { ID: analogCounts+index, Meter: meterKey, Asset: '', MeasurementType: 'Digital', MeasurementCharacteristic: 'Instantaneous', Phase: this.parsePhase(a[2]), Name: a[1], SamplesPerHour: 0, PerUnitValue: null, HarmonicGroup: 0, Description: a[3], Enabled: true, Series: { ID: 0, ChannelID: 0, SeriesType: 'Values', SourceIndexes: a[0] } as OpenXDA.Series } as OpenXDA.Channel })
