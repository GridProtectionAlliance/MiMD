...
export namespace MiMD {
    ...
    interface IDiagnosticRules { ID: number, FilePattern: string, Field: string, RegexPattern: string, Text: string, Severity: number, ReverseRule: boolean, SQLQuery: string}
