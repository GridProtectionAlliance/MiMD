...
namespace WixFolderGen
{
    class Solution
    {
        ...
        public Solution(string projectName, string rootFolderName, string applicationFolder, string fileNamePostfix)
        {
            ...
            WebFeaturesDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\MiMDSetup\\WebFeatures"+fileNamePostfix +".wxi";
            WebFoldersDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\MiMDSetup\\WebFolders" + fileNamePostfix + ".wxi";
            WebFilesDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\MiMDSetup\\WebFiles" + fileNamePostfix + ".wxi";
        }
    ...
    class Program
    {
        static void Main()
        {
            ...
            {
                new Solution("", "wwwroot", "Applications\\MiMD", "")
            };
